...
import com.czxy.bos.service.PromotionService;
...
public class PromotionController {
    ...
    /**
     * 如何传递参数？
     * @RequestBody EsPromotion promotion:报错
     * @return
     *
     ...
     */
    @GetMapping
    public ResponseEntity<DataGridResult> findPromotionByPage(Integer page, Integer rows,Promotion promotion){
        try {
            DataGridResult result = promotionService.findPromotionByPage(page, rows,promotion);
